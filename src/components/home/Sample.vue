<template>
  <el-container id="sample-chart">
    <vue-echarts id="GDP" :options="getGDP()"></vue-echarts>
...
export default {
  ...
  methods: {
    ...
    getGDP () {
      ...
      dataMap.dataGDP = this.GDPDataFormatter({
        // max : 60000,
      ...
      dataMap.dataPI = this.GDPDataFormatter({
        // max : 4000,
      ...
      dataMap.dataSI = this.GDPDataFormatter({
        // max : 26600,
      ...
      dataMap.dataTI = this.GDPDataFormatter({
        // max : 25000,
      ...
      dataMap.dataEstate = this.GDPDataFormatter({
        // max : 3600,
      ...
      dataMap.dataFinancial = this.GDPDataFormatter({
        // max : 3200,
